...
import { type CharacterStoreInfo, defineCharacterInfo } from "./CharacterInfo.ts"
import { defineNicknameInfo, type NicknameInfo } from "./NicknameInfo.ts"
import { defineClearInfo } from "./ClearInfo.ts"
import { Job } from "../struct/MS2Job.ts"
import type { CharacterInfo, MainCharacterInfo, TrophyCharacterInfo } from "../struct/MS2CharInfo.ts"
import { shrinkProfileURL } from "../util/MS2FetchUtil.ts"
...
export class MS2Database extends SequelizeLite {
  ...
  public constructor(dbPath: string) {
    super(dbPath)
    // 클리어 정보 불러오기
    for (const [dungeonStr] of Object.entries(MS2Database.supportedDungeons)) {
